  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-sm bg-surface border border-border rounded-xl p-8">
        <h1 className="font-display text-xl font-semibold text-ink">SIMONEV Eksekutif</h1>
        <p className="text-sm text-muted mt-1">Dashboard Pimpinan Daerah — Kabupaten Boyolali</p>
        ...
        <form action={loginAction} className="mt-6 flex flex-col gap-4">
          ...
          <button type="submit" className="mt-2 px-4 py-2.5 rounded-lg bg-primary text-white text-sm font-semibold">
            Masuk
          </button>
        </form>
      </div>
